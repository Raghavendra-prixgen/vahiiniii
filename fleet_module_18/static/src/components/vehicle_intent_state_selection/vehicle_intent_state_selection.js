...
export class VehicleIntentState extends StateSelectionField {
    setup() {
        this.state = useState({
...
VehicleIntentState.template = "fleet_module_18.VehicleIntentState";


VehicleIntentState.props = {
    ...stateSelectionField.component.props,
    isToggleMode: { type: Boolean, optional: true },
    viewType: { type: String },
}
export const vehicleIntentState = {
    ...stateSelectionField,
    component: VehicleIntentState,
...
registry.category("fields").add("vehicle_intent_state_selection", vehicleIntentState);
